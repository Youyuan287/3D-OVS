...
本轮实验表明，THGS 在 object-level 上的主要瓶颈不是候选完全缺失，而是候选选择和语义路由不足。通过 ReLaGS-inspired GPT-SoM rerouting，四场景总体 mIoU 从 0.5885 提升到 0.6748，oracle 上限达到 0.7362，证明引入视觉大模型进行候选选择是有效方向，也为后续设计可复现的 reranker 或蒸馏模块提供了明确依据。
